...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Machines Admin</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="machines.php">Machines</a></li>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Manage homepage carousel banners</p>
                        <a href="banners.php" class="btn btn-primary">Manage Banners</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Manage machine listings</p>
                        <a href="machines.php" class="btn btn-primary">Manage Machines</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">View customer enquiries</p>
